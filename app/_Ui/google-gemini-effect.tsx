  ...
  return (
    <div className={cn("sticky top-40", className)}>
      ...
      <p className="text-lg md:text-6xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
        {title || `Hello I'm Laeba Firdous, Front End Developer`}
      </p>
      <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
        {description ||
          ` I like to turn my creative ideas into reality through  Crafting digital experiences that leave a lasting impression in the hearts and minds of users.`}
      </p>
      </div>
      
      <div className="w-full h-[890px] -top-40 md:-top-24  flex items-center justify-center bg-red-transparent absolute ">
        <div className="z-30 flex gap-10">
          <HoverBorderGradient
            onClick={openResume}
